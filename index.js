...
case 'howak':
case 'hoax':
const howa = fs.readFileSync('./assets/howak.mp3');
client.sendMessage(from, howa, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'iri':
...
case 'Telat':
case 'ngentod':
const ngen = fs.readFileSync('./assets/ngentod.mp3');
client.sendMessage(from, ngen, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'pale':
